...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_pages = "INSERT INTO pages (title, description, uploader, date, page_type) VALUES ('$title', '$description', '$uploader', NOW(), 'esportpage')";

    // Insert data into 'feitpage' table
    $sql_esportpage = "INSERT INTO esportpage (title, description, uploader, anonymous, date, page_type) VALUES ('$title', '$description', '$uploader', $anonymous, NOW(), 'esportpage')";

    // Execute the queries
    if (mysqli_query($connection, $sql_pages) && mysqli_query($connection, $sql_esportpage)) {
