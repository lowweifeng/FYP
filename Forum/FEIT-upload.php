...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_pages = "INSERT INTO pages (title, description, uploader, date, page_type) VALUES ('$title', '$description', '$uploader', NOW(), 'feitpage')";

    // Insert data into 'feitpage' table
    $sql_feitpage = "INSERT INTO feitpage (title, description, uploader, anonymous, date, page_type) VALUES ('$title', '$description', '$uploader', $anonymous, NOW(), 'feitpage')";

    // Execute the queries
    if (mysqli_query($connection, $sql_pages) && mysqli_query($connection, $sql_feitpage)) {
        echo "Data uploaded successfully to both tables.";
        header("Location: FEIT.php");
        exit();
    } else {
