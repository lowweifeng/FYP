...
<body>
  ...
  <div class="pages-container">
    <div class="row">
      ...
      <div class="col-md-9">
        ...
        $pageType = 'esportpage'; // Specify the common page_type value
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          $replySql = "SELECT * FROM esport_replies WHERE post_id = '$postId'";
          ...
          // Reply button
          echo '<a href="E-Sport_reply.php?post_id=' . $postId . '" class="btn btn-reply">Reply</a><br><br>';
          echo '</div>';
        }
  ...
  <a href="E-Sport-upload.php" class="btn btn-upload">Upload</a>
</body>
