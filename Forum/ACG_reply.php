...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO acg_replies (post_id, content, uploader, date) VALUES ('$postId', '$replyContent', '$uploader', NOW())";

    // Execute the query
    if (mysqli_query($connection, $sql)) {
        echo "Reply uploaded successfully.";
        // Redirect the user back to the original post after submitting the reply
        header("Location: ACG.php"); // Adjust the URL as needed
        exit();
    } else {
        ...
        <div class="reply-container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form method="POST" action="ACG_reply.php?post_id=<?php echo $_GET['post_id']; ?>">
                        <fieldset>
                            <legend>Reply</legend>
